...
import {MainTicketLeft, MainTicketRight, PartyImage, Barcode, Sport,AcadamicIcon,Career,Culture, Technology, entertaiment, Workshopes} from "../../public"
  ...
  return (
    <div className="w-full flex justify-center">
      <div className="w-full flex flex-col max-w-[1400px]">
        ...
        <div className="justify-between   py-5 border-b border-[#ADADAD40] items-center flex w-full">
  {cards.map((card) => (
    <TypeCard key={card.id}   name={card.name} Image={card.img} className="" />
  ))}
</div>
