        ...
        <div className="w-full flex justify-center items-center">
          ...
          >
            <div className="flex w-full   items-end ">
              <div className="w-[50%]  rounded-[20px] bg-green-300 flex flex-col pt-[112px] gap-[144px]">
                <div className="flex flex-col gap-[40px] px-[82px] ">
                ...
                <div className="px-[84px]  pb-[112px] ">
