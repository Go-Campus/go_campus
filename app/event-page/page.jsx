...
export default function EventPage() {
    ...
    return (
        <div className="bg-white w-full flex flex-col  items-center justify-center">
            ...
            {/* Top Grid */}
            <div className="w-full max-w-[var(--max-container-width)] px-4 sm:px-6 py-6 grid grid-cols-1 lg:grid-cols-3 gap-10" style={containerStyle}  >
                {/* Poster */}
            ...
            <div className=" w-full max-w-[var(--max-container-width)] px-4 grid grid-cols-1 lg:grid-cols-3 gap-6" style={containerStyle}>
                {/* Details */}
                <div className="lg:col-span-2">
                    ...
                    <div className="w-ful">
                        ...
                        {aboutEventContent.paragraphs.map((para, index) => (
                            <p key={index} className=" text-[18px] leading-[28px] text-gray-700 mb-4">
                                {para}
                            </p>
                        ))}
                    ...
                    {/* Location */}
                    <div className="mt-10">
                        <h2 className="font-semibold text-[22px] leading-[60px] capitalize align-middle">Location</h2>
                    ...
                    <div className="mt-10 bg-red-50 rounded-2xl border border-red-100 p-6">
                        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between mb-4 gap-4">
                            ...
                            <div className="self-start sm:self-center">
                                <button
                                    className="w-full sm:w-auto bg-[#FF5F4A] px-3 py-2 text-white rounded-md"
                                >
                                    Follow
                                </button>
                        ...
                        <p className="text-gray-700 text-[18px] leading=[28px] mb-4">
                            ...
                            Both Investors & Founders believe meeting in-person is far more effective to discuss investment rather than sending emails, cold calls & knocking on doors.
                        </p>
                ...
                <div className="bg-[#FFEDEA] border border-[#FFD4D4]  rounded-[30px] shadow-md h-fit w-full max-w-sm mx-auto">
                    ...
                    <div className="flex justify-center mb-4">
                        <button className="px-5 py-2 text-white bg-[#FF5F4A] rounded-md text-sm font-medium">
                            Register Now
                        </button>
                    </div>
                </div>
            ...
            {/* More Events Section */}
            <section className="w-full max-w-[var(--max-container-width)] px-4 gap-6 mt-5" style={containerStyle}>
            ...
            <section className="w-full max-w-[var(--max-container-width)] px-4 gap-6 my-10" style={containerStyle}>
